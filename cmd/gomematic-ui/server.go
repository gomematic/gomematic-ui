...
import (
	...
	"github.com/gomematic/gomematic-ui/pkg/handler"
	"github.com/gomematic/gomematic-ui/pkg/middleware/header"
	"github.com/gomematic/gomematic-ui/pkg/middleware/requests"
	...
	return &cli.Command{
		...
		Flags: []cli.Flag{
			&cli.StringFlag{
				...
				EnvVars:     []string{"GOMEMATIC_UI_HOST"},
			...
			&cli.StringFlag{
				...
				EnvVars:     []string{"GOMEMATIC_UI_ADDR"},
			...
			&cli.StringFlag{
				...
				EnvVars:     []string{"GOMEMATIC_UI_ROOT"},
			...
			&cli.StringFlag{
				...
				EnvVars:     []string{"GOMEMATIC_UI_STATIC"},
			...
			&cli.StringFlag{
				...
				EnvVars:     []string{"GOMEMATIC_UI_STORAGE"},
			...
			&cli.BoolFlag{
				...
				EnvVars:     []string{"GOMEMATIC_UI_PPROF"},
			...
			&cli.StringFlag{
				...
				EnvVars:     []string{"GOMEMATIC_UI_CERT"},
			...
			&cli.StringFlag{
				...
				EnvVars:     []string{"GOMEMATIC_UI_KEY"},
			...
			&cli.BoolFlag{
				...
				EnvVars:     []string{"GOMEMATIC_UI_LETSENCRYPT"},
			...
			&cli.BoolFlag{
				...
				EnvVars:     []string{"GOMEMATIC_STRICT_CURVES"},
			...
			&cli.BoolFlag{
				...
				EnvVars:     []string{"GOMEMATIC_STRICT_CIPHERS"},
			...
			&cli.StringFlag{
				...
				EnvVars:     []string{"GOMEMATIC_UI_ENDPOINT"},
